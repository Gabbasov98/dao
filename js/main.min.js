...
if(closeDateFilterMobButton){
    closeDateFilterMobButton.addEventListener('swiped-down',function (e) {
        ...
        $(".m-page").removeClass("_open-calendar")
        setTimeout(()=>{
...
$('[name="pricing"]').change(function () {
    ...
    if(!checked){
        if($(this).parents(".pricing__item").hasClass("pricing__free")){
            $(".pricing__count").addClass("_active")
        }
        if($(this).parents(".pricing__item").hasClass("pricing__count")){
            $(".pricing__count").addClass("_active")
        }
    }
})
...
$(".param-select").each(function (i,el) {
    ...
    function setActiveOption() {
        let activeOptions = $(el).find(".param-select__option input:not(._disabled):checked")
    ...
    $(el).find(".param-select__clear,._clear-filter-item").click(function (e) {
        ...
        let disabledInput = $(el).find(".param-select__option ._disabled")
        $(disabledInput).prop("checked",true)
